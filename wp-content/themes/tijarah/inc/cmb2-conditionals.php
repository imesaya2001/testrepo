...
if ( ! class_exists( 'tijarah_CMB2_Conditionals', false ) ) {

	/**
	 * tijarah_CMB2_Conditionals Plugin.
	 */
	class tijarah_CMB2_Conditionals {
		...
		public function admin_footer() {
			...
			$enqueue_script = apply_filters( 'tijarah_CMB2_Conditionals_enqueue_script', $enqueue_script );

			// possibility to change script source
			$script_src = apply_filters( 'tijarah_CMB2_Conditionals_enqueue_script_src', get_template_directory_uri() . '/assets/js/admin/cmb2-conditionals.js' );
	...
	if ( ( function_exists( 'wp_installing' ) && wp_installing() === false ) || ( ! function_exists( 'wp_installing' ) && ( ! defined( 'WP_INSTALLING' ) || WP_INSTALLING === false ) ) ) {
		add_action( 'init', 'tijarah_CMB2_Conditionals_init' );
	}

	if ( ! function_exists( 'tijarah_CMB2_Conditionals_init' ) ) {
		/**
		 * Initialize the class.
		 */
		function tijarah_CMB2_Conditionals_init() {
			static $tijarah_CMB2_Conditionals = null;
			if ( null === $tijarah_CMB2_Conditionals ) {
				$tijarah_CMB2_Conditionals = new tijarah_CMB2_Conditionals();
			}

			return $tijarah_CMB2_Conditionals;
		}
	}
