...
LEFT JOIN {$wpdb->prefix}usermeta ON {$wpdb->prefix}wc_customer_lookup.user_id = {$wpdb->prefix}usermeta.user_id AND {$wpdb->prefix}usermeta.meta_key = 'payhere_customer_data'  WHERE NOT ISNULL(meta_value) ";
    ...
    protected function get_views()
    {
        ...
        $status_links = array(
//            "tokenized" => sprintf('<a href="?page=%s&ft=%s&s=%s" class="%s">Saved Payment Methods</a>', esc_attr($_REQUEST['page']), 'tokenized', $s, $ft == 'tokenized' ? 'filter-active' : ''),
