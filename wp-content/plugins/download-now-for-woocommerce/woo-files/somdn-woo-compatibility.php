 ...
 * @since 2.3.6
 */
add_action('somdn_settings_subtabs_after_multiple', 'somdn_settings_subtabs_memberships', 20);
...
add_action('somdn_settings_page_content', 'somdn_settings_content_memberships');
