...
add_filter('somdn_get_settings_sub_tabs', 'somdn_get_settings_sub_tabs_support_woo_basic');
...
add_action('somdn_settings_after_settings', 'somdn_settings_support_tab_woo_basic');
