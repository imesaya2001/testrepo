...
// Download
class tijarah_Widget_Photo_Product extends Widget_Base {
   ...
   public function get_title() {
      return esc_html__( 'Photo Product', 'tijarah' );
   }
   ...
   protected function _register_controls() {
      ...
      $this->start_controls_section(
         'photo_product_section',
         [
            'label' => esc_html__( 'Photo Product', 'tijarah' ),
   ...
   protected function render( $instance = [] ) {
      ...
      $settings = $this->get_settings_for_display(); ?>
         ...
         <div class="download_items row justify-content-center masonry-grid zoom-gallery">
            ...
            while ( $download->have_posts() ) : $download->the_post(); ?>
               ...
               <div class="<?php echo esc_attr($settings['columns']) ?>">
                  <?php get_template_part( 'template-parts/product-type/photo', 'item' ); ?>
               </div>
...
Plugin::instance()->widgets_manager->register_widget_type( new tijarah_Widget_Photo_Product );